...
- `navigation` is an array of menu entries; use `categories: true` to render links from post categories automatically
- `navigation_category_exclusions` is an array of category names to hide from generated navigation and category archives
